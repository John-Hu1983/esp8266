...
void TEST_Menu1(void)
{
	...
	GUI_ShowString(20, 16, (u8 *)"A.", 16, 1);
	GUI_ShowString(20, 32, (u8 *)"B.", 16, 1);
	GUI_ShowString(20, 48, (u8 *)"C.", 16, 1);
...
void TEST_Menu2(void)
{
	...
	GUI_ShowString(0, 1, (u8 *)"2018-08-25", 8, 1);
	GUI_ShowString(78, 1, (u8 *)"Saturday", 8, 1);
	GUI_ShowString(14, HEIGHT - 1 - 10, (u8 *)"Cloudy", 8, 1);
	GUI_ShowString(WIDTH / 2 - 1 + 2, 13, (u8 *)"TEMP", 8, 1);
	GUI_DrawCircle(WIDTH - 1 - 19, 25, 1, 2);
	GUI_ShowString(WIDTH - 1 - 14, 20, (u8 *)"C", 16, 1);
